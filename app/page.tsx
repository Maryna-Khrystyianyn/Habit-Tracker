      ...
      <div className="flex flex-col  justify-center items-center sm:items-start">
        ...
        {user.id && (
          <div className="flex flex-col gap-3  justify-center items-center sm:items-start sm:mt-5">
            <p className="text-xl text-[#e93f2e] text-center font-bold sm:text-left">
            ...
            <Link
              className="sm:mt-10 bg-green-800 w-[200px] flex justify-center text-white p-2 rounded-xl"
              href={`/user/${user.id}`}
            >
              Get Start!
            </Link>
